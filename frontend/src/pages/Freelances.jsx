    ...
    return (
        <div className="bg-background">
            ...
            <main className="font-jetbrains">
                <section className="sm:w-[98.9vw] h-[25vh] sm:h-[45vh] bg-bg_botao-login flex flex-col items-center justify-center gap-[1vh] sm:gap-[2vh]  border-b-verde_principal border-[0.1vh] border-r-bg_botao-login border-l-bg_botao-login">
                ...
                <section className="flex pt-[5vh] flex-col gap-[5vh] ">
                ...
                <div
                className="flex items-end mb-[2vh] justify-center h-[10vh] text-verde_principal">
