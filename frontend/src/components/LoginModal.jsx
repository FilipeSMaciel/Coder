...
export default function LoginModal({ onLogin }) {
  ...
  return (
    <section className="flex z- items-center justify-center w-[75vw] sm:w-[60vw] h-[70vh] sm:h-[70vh]">
      ...
      <div className="relative w-full h-full  overflow-hidden flex justify-center items-center">
        ...
        >
          ...
          {isLoggedIn ? (
            ...
            <div className="flex flex-col w-[65vw] items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <form className="w-full flex flex-col items-center gap-4" onSubmit={handleSubmit(onSubmitLogin)}>
                ...
                <input
                  ...
                  name="password"
                  placeholder="Senha"
                  className="border border-gray-300 rounded-md p-2 w-full sm:w-[20vw] sm:w-[20vw]"
                  required
                  {...register("password")}
                />
                <button
