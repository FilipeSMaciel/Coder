...
export default function LoginModal({ onLogin }) {
  ...
  <button
    className="absolute top-4 right-4 text-gray-600 hover:text-red-500 text-2xl font-bold cursor-pointer"
    onClick={handleLogout} // Ou a função que você deseja para fechar o modal
  >
    &times;
  </button>
  ...
  <div className="relative w-full h-full overflow-hidden flex justify-center items-center">
    ...
    <div
      className={`absolute -z-0 w-1/2 flex flex-col items-center transition-transform duration-1000 ease-in-out sm:${
        isRegistering ? "translate-x-[50%]" : "translate-x-[-50%]"
      }`}
    >
